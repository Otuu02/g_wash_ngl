              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildSubRow('Washer 90% Share', '₦${NumberFormat('#,##0.00').format(providerShare)}', color: Colors.green.shade700),
                    _buildSubRow('Platform 10% Fee', '₦${NumberFormat('#,##0.00').format(platformFee)}', color: Colors.orange.shade800),
                  ],
                ),
              ),
